...
namespace BEPUphysics.BroadPhaseEntries
{
	...
	public class DetectorVolume : BroadPhaseEntry, ISpaceObject, IDeferredEventCreator
	{
		...
		public bool IsPointContained(BEPUutilities.Vector3 point)
		{
		...
		internal bool IsPointContained(ref BEPUutilities.Vector3 point, RawList<int> triangles)
		{
			BEPUutilities.Vector3 rayDirection;
			...
			BEPUutilities.Vector3.Add(ref boundingBox.Max, ref boundingBox.Min, out rayDirection);
			BEPUutilities.Vector3.Multiply(ref rayDirection, F64.C0p5, out rayDirection);
			BEPUutilities.Vector3.Subtract(ref point, ref rayDirection, out rayDirection);
			//If the point is right in the middle, we'll need a backup.
			if (rayDirection.LengthSquared() < F64.C0p01)
				rayDirection = BEPUutilities.Vector3.Up;
		...
		public void Reinitialize()
		{
			...
			BEPUutilities.Vector3 origin = (triangleMesh.Tree.BoundingBox.Max - triangleMesh.Tree.BoundingBox.Min) * F64.C1p5 + triangleMesh.Tree.BoundingBox.Min;
