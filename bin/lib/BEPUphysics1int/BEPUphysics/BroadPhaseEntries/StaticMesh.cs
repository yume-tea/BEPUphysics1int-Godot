...
namespace BEPUphysics.BroadPhaseEntries
{
	...
	public class StaticMesh : StaticCollidable
	{
		...
		public StaticMesh(BEPUutilities.Vector3[] vertices, int[] indices)
		{
		...
		public StaticMesh(BEPUutilities.Vector3[] vertices, int[] indices, AffineTransform worldTransform)
		{
		...
		internal TriangleSidedness sidedness = TriangleSidedness.Counterclockwise;
		///<summary>
